import { FlatList, Keyboard, Modal, StyleSheet, Text, TouchableWithoutFeedback, View } from 'react-native'
...
import { AddNewAccount, AddNewAccountButton } from '../components/dashboard/add_new_account'
...
const Dashboard = () => {
  ...
  return (
    ...
    >
      ...
      ListEmptyComponent={<Text>No account associated with this account</Text>}
      ListFooterComponent={<AddNewAccountButton onPress = {()=>setModalVisible(true)}/>}
      />
