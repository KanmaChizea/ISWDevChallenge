import { ActivityIndicator, Keyboard, SafeAreaView, StyleSheet, Text, TouchableOpacity, TouchableWithoutFeedback, View } from "react-native"
...
export const LoginScreen = ({navigation}: LoginScreenNavigationProp)=>{
    ...
    const loginFunction =async (isBiometrics: boolean)=>{
        ...
        if(isValidate){
            setLoading(true);
            const result =await API.login({username: username, password:password, isBiometrics:isBiometrics});
    ...
    <SafeAreaView style={styles.container}>
        ...
        <View>
            ...
            <Text style={styles.signUpText}> New to mobile banking? 
